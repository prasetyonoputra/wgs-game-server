...
public class RadarSatuanScript : MonoBehaviour
{
    ...
    public void DeleteEntityFromRadar(GameObject other)
    {
    ...
    private void OnTriggerStay2D(Collider2D other)
    {
        if (other.CompareTag("Badan Entity"))
        {
            ...
            if (entity.id_entity == "satuan_11_18_338")
            {
                Debug.Log("Sentuh: " + entityMusuh.id_entity);
            }
            ...
            if (entity.detector != null)
            {
                ...
                {
                    //if (entity.id_entity == "satuan_11_18_338") Debug.Log("Radarnya nyala!");
